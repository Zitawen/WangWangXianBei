    ...
    SlideVerify.prototype = {
        ...
        initDom: function () {
            var html = $(
                ...
                '</span>' +
                '<span class="fix-tips fixTips flash">' +
...
//					_this.cancelTouchmove();
    ...
    var inlineCss = '*{margin:0;padding:0;box-sizing:border-box}' +
        ...
        '.flash {\n' +
        '            background: -webkit-gradient(linear, left top, right top, color-stop(0, white), color-stop(.4, white), color-stop(.5, white), color-stop(.6, white), color-stop(1, #b2faba));\n' +
